 ...
 * @date    2011-04-25
 */
class M_seminar_attendees extends MY_Model {

    private $_table_name = 'seminar_attendees';
    ...
    {
        $this->db->select(
                '*, seminar_attendees.date_posted AS attendee_date_posted, CONCAT(address1, " ", address2, " ,", city, " ,", states.state_name, " ,", zip , " ,", country.name) AS attendee_address',
                FALSE
                );
        $this->db->join('seminars', 'seminars.seminar_id = ' . $this->_table_name . '.seminar_id', 'left');
        ...
        $this->db->order_by('seminar_attendees.date_posted DESC');
