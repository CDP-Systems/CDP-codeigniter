<script type='text/javascript'>
	function deleteItem(id){
		...
		if(ans){
			window.location = "<?php echo base_url(); ?>'admin/self_assessment/delete_response/" + id;
		}
	}
                ...
                <?php foreach($responses as $row): ?>
                    <tr>                      	
                        ...
                        <td width="70">
                            ...
                            <li class="link01">
                                <a title="View responses" href="<?php echo site_url('admin/self_assessment/user_response/' . $row->response_id);?>"></a>
                            </li>    
                            <li class="link03">
