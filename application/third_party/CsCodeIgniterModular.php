 ...
 */
	...
	// CS - check the modules directory first.
	if ( ! file_exists(MODPATH . $RTR->fetch_module() . '/' . $RTR->fetch_directory() . 'controllers/'.$RTR->fetch_class().EXT))
	{
	...
	{
	    include(MODPATH . $RTR->fetch_module() . '/' . $RTR->fetch_directory() . 'controllers/'.$RTR->fetch_class().EXT);
	}
