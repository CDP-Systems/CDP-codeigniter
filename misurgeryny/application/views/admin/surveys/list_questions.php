...
<div class="content-container">
    <div style="background:#d1dde0;">
        <div class="title">
            ...
            <?php $this->load->view('admin/surveys/tabs', array('questions' => 'active'));?>            
            <div class="clear"></div>
        </div>            
        <div class="clear"></div>
    </div>
                ...
                <?php foreach($questions as $row): ?>
                    <tr>               
                        ...
                        <td width="70">
                            ...
                            <li class="link02">
                                <a title="Edit" href='<?php echo site_url('admin/surveys/edit_question/' . $row->question_id);?>'></a>
                            </li>
                            <li class="link03">
                                <a title="Delete" class="delete" href="<?php echo site_url('admin/surveys/delete_question/' . $row->question_id);?>"></a>
                            </li>
