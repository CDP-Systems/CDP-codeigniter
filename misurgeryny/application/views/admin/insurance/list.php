<div class="content-container">
    ...
    <div class="content-text">
        ...
        <form name='pageForm' method='post' action='<?php echo site_url('admin/insurance/action');?>'>
            <div>                    
                ...
                <a href='<?php echo base_url().index_page(); ?>admin/insurance/export' >Export </a>
                </div>                      	
            </div>
            ...
            <table cellpadding="10" cellspacing="0" border="0" class="list" width="100%">
                ...
                <?php foreach($insurances as $row): ?>
                    <tr>   
                    	<td width="40"><input type='checkbox' value='<?php echo $row->insurance_id;?>' name='insurances[]' id='checkboxes'  /></td>                     
                        <td><?php echo $row->patient_name; ?></td>
                        <td><?php echo $row->email;?></td>
                        <td><?php echo $row->home_phone;?></td>
                        <td><?php echo date('F j, Y', strtotime($row->date_submitted));?></td>                        
                        <td width="70">
                            <ul class="action-btns">
                            <li class="link01">
                                <?php echo anchor('admin/insurance/view/' . $row->insurance_id,'<span class="hide">View</span>');?>
                            </li>
                            <li class="link03">
                                <a href="<?php echo site_url('admin/insurance/delete') . '/' . $row->insurance_id;?>" title="Delete" class="delete"></a>
                            </li>
