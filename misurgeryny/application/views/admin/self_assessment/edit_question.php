...
<div class="content-container">
    <div style="background:#d1dde0;">
    	<div class="title">
            ...
            <?php $this->load->view('admin/self_assessment/tabs', array('add_question' => 'active'));?>
            <div class="clear"></div>
        </div>                                    
        <div class="clear"></div>
    </div>
    <div class="content-text">
        ...
        <form action="" method="post" class="require-validation" name="edit-question-form">
            ...
            <table cellpadding="8" cellspacing="1" width="100%">
              <tr bgcolor="#F1F1F1">
                <td width="200">Self Assessment:</td>
                <td>
                    <?php echo form_dropdown('self_assessment_id[]', self_assessment_dropdown(), (isset($self_assessment_id)) ? $self_assessment_id : '', 'multiple');?>
                    <?php echo form_error('self_assessment_id[]');?>
                </td>
              </tr>
              <tr bgcolor="#F1F1F1">
              ...
              <tr bgcolor="#F1F1F1">
                ...
                <td>
                    <?php echo form_dropdown('type_of_question_id', question2_type_dropdown(), (isset($type_of_question_id)) ? $type_of_question_id : '', 'class="type-dropdown required number min(0)"');?>
